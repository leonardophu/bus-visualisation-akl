...
full_bus_data$act_arrival_time = full_bus_data$act_arrival_time + 43200

full_bus_data$act_arrival_time_date = as.POSIXct(full_bus_data$act_arrival_time, origin = "1970-01-01", tz = "UTC")
